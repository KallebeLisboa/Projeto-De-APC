...
def escolha():
    opcoes = {
        1: conversao_sabao,
        2: conversao_vela,
        3: finalizar.finalizar_Sub_menu,
    }
    ...
    while True:
        ...
        while True:
            decisao = input("Digite sua opção (1 a 3): ").strip()
            print("=-" * 15)

    # Verifica se a entrada contém apenas números
            if not decisao.isdigit():
                print("Digite um valor válido: apenas números inteiros de 1 a 3 são permitidos.")
                continue
    ...
    # Verifica se o número está no intervalo permitido
            if decisao < 1 or decisao > 3:
                print("Digite um número válido dentro do intervalo (1 a 3).")
                continue
